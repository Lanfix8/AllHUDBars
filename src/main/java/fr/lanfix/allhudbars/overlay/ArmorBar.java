...
public class ArmorBar {
    ...
    public static void renderArmorBar(DrawContext context, PlayerEntity player, int y, int left) {
        ...
        if (armor > 0) {
            ...
            context.drawText(mc.textRenderer, String.valueOf(armor), left + offX + 1, y + offY, 0x000000, false);
            context.drawText(mc.textRenderer, String.valueOf(armor), left + offX - 1, y + offY, 0x000000, false);
            context.drawText(mc.textRenderer, String.valueOf(armor), left + offX, y + offY + 1, 0x000000, false);
            context.drawText(mc.textRenderer, String.valueOf(armor), left + offX, y + offY - 1, 0x000000, false);
            context.drawText(mc.textRenderer, String.valueOf(armor), left + offX, y + offY, 0xB7B8C2, false);
