...
public class AirBar {
    ...
    public static void renderAirBar(DrawContext context, PlayerEntity player, int y, int right) {
        ...
        if (player.isSubmergedInWater() || air < maxAir) {
            ...
            context.drawTexture(RenderPipelines.GUI_TEXTURED, emptyBar, right - textureWidth, y, 0, 0, textureWidth - airWidth, 9, textureWidth, 9);
            context.drawTexture(RenderPipelines.GUI_TEXTURED, fullBar, right - airWidth, y, textureWidth - airWidth, 0, airWidth, 9, textureWidth, 9);
        }
    }
